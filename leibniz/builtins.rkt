...
(module+ test
  ...
  (check-equal? (sort-of-numarg-term integer-signature '+ (list 0 0)) 'Natural)
  ...
  (check-equal? (sort-of-numarg-term integer-signature '* (list 1 2)) 'NonZeroNatural)
  (check-equal? (sort-of-numarg-term integer-signature '* (list 0 2)) 'Natural)
  (check-equal? (sort-of-numarg-term integer-signature '* (list -2 0)) 'Integer)
  ...
  (check-equal? (sort-of-numarg-term integer-signature 'div (list 0 1)) 'Natural)
  (check-equal? (sort-of-numarg-term integer-signature 'rem (list -2 -2)) 'Integer)
  (check-equal? (sort-of-numarg-term integer-signature 'rem (list 0 1)) 'Natural)
...
(module+ test
  ...
  (check-equal? (sort-of-numarg-term rational-signature
                                     '* (list 1/2 2/3)) 'PositiveRational)
  (check-equal? (sort-of-numarg-term rational-signature
                                     '* (list 0 2/3)) 'NonNegativeRational)
  (check-equal? (sort-of-numarg-term rational-signature
